        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-12">
            ...
            <div className="grid grid-cols-4 gap-2 sm:gap-4 mt-2 sm:mt-4">
              {[...Array(4)].map((_, i) => (
                <Skeleton
                  key={i}
                  height={80}
                  className="rounded-lg sm:h-[100px]"
                />
              ))}
            </div>
          </div>
          <div>
            <Skeleton
              width={200}
              height={32}
              className="mb-4 sm:mb-6 sm:h-[40px]"
            />
            <Skeleton
              width={120}
              height={24}
              className="mb-3 sm:mb-4 sm:h-[30px]"
            />
            ...
            <Skeleton
              width={160}
              height={40}
              className="mt-6 sm:mt-8 sm:h-[50px]"
            />
          </div>
        </div>
      </div>
        ...
        <ol className="flex items-center space-x-2 sm:space-x-4 whitespace-nowrap">
          <li>
            <div className="flex items-center">
              <a
                href="/"
                className="text-xs text-gray-400 hover:text-gray-500 sm:text-sm"
              >
                Home
              </a>
            </div>
          ...
          <div className="mt-6 sm:mt-8">
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
              <div className="flex items-center border rounded-md w-full sm:w-auto">
                ...
                <span className="px-2 sm:px-4 py-2 text-center w-12">
                  {quantity}
                </span>
                <button
